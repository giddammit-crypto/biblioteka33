...
## 2026-02-04 - HTML Structure and Accessibility
**Learning:** Structural validation (like closing tags for landmarks) is a prerequisite for accessibility. Missing tags like `</main>` can confuse screen readers and invalidate skip links.
**Action:** Always verify the integrity of opening/closing tags for major landmarks (`header`, `main`, `footer`) across partials.
