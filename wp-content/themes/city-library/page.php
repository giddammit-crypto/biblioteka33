...
<div class="w-full max-w-[95%] mx-auto px-4 sm:px-6 lg:px-8 py-12">
    <div id="primary" class="w-full transition-all duration-300 max-w-6xl mx-auto">
        ...
        while (have_posts()) :
            the_post();
            ?>
            <article id="post-<?php the_ID(); ?>" <?php post_class('bg-white dark:bg-slate-900/50 p-8 md:p-12 rounded-[2rem] shadow-xl border border-slate-100 dark:border-slate-800 relative overflow-hidden bg-pattern-slate'); ?>>
