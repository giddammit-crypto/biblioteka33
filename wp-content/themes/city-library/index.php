...
<div class="w-full max-w-[95%] sm:max-w-[90%] xl:max-w-[85%] 2xl:max-w-[80%] mx-auto px-4 sm:px-6 lg:px-8 py-8">
    ...
    <div class="flex flex-col lg:flex-row gap-8 items-start">
        ...
        <div id="primary" class="w-full <?php echo $show_sidebar ? 'lg:w-[70%]' : ''; ?> transition-all duration-300">
            ...
            <div class="content-area bg-white dark:bg-slate-900/50 p-8 md:p-12 rounded-[2.5rem] border border-slate-100 dark:border-slate-800 bg-pattern-slate shadow-xl <?php echo city_library_get_animation_class(); ?>">
