    ...
    <div class="w-full lg:max-w-[80%] lg:mx-auto px-0 lg:px-8">
        ...
        <div class="py-12 flex items-center justify-center">
             <?php if ($inter_block_text) : ?>
                <div class="w-full bg-white text-slate-800 text-center py-4 px-6 rounded-[2rem] shadow-lg border border-slate-100 bg-pattern-slate">
        ...
        if ($links_present) : ?>
            <div class="swiper important-links-slider w-full px-4 lg:px-0 lg:overflow-visible !overflow-visible">
                <div class="swiper-wrapper lg:grid lg:grid-cols-4 xl:grid-cols-8 lg:gap-6">
                    <?php for ($i = 1; $i <= 8; $i++) :
