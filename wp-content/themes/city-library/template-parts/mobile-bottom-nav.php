...
<nav class="lg:landscape:hidden fixed bottom-0 left-0 w-full bg-white/95 backdrop-blur-md shadow-[0_-4px_6px_-1px_rgba(0,0,0,0.1)] z-50 border-t border-slate-200 safe-area-bottom">
    <div class="grid grid-cols-4 items-center h-20">
        <!-- Home -->
        <a href="<?php echo esc_url(home_url('/')); ?>" class="group flex flex-col items-center justify-center h-full text-slate-500 hover:text-primary active:text-primary transition-all focus-visible:ring-2 focus-visible:ring-inset focus-visible:ring-primary/50 rounded-lg">
        ...
        <!-- Events (Afisha) -->
        <a href="#afisha" class="group flex flex-col items-center justify-center h-full text-slate-500 hover:text-primary active:text-primary transition-all focus-visible:ring-2 focus-visible:ring-inset focus-visible:ring-primary/50 rounded-lg">
        ...
        <button onclick="document.getElementById('search-toggle').click();" class="group flex flex-col items-center justify-center h-full text-slate-500 hover:text-primary active:text-primary transition-all focus:outline-none focus-visible:ring-2 focus-visible:ring-inset focus-visible:ring-primary/50 rounded-lg">
        ...
        <button onclick="document.getElementById('mobile-menu-btn').click();" class="group flex flex-col items-center justify-center h-full text-slate-500 hover:text-primary active:text-primary transition-all focus:outline-none focus-visible:ring-2 focus-visible:ring-inset focus-visible:ring-primary/50 rounded-lg">
