...
?>
<article class="group relative flex flex-col h-full bg-white rounded-[2rem] overflow-hidden shadow-xl lg:hover:shadow-2xl transition-all duration-300 lg:hover:-translate-y-1 active:scale-[0.98] border border-slate-100 isolate shrink-0 w-[85vw] sm:w-[320px] lg:w-auto snap-center" style="background-color: <?php echo esc_attr($bg_color); ?>;">
