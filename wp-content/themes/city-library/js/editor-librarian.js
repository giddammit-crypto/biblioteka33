(function(wp) {
    ...
    const aiIcon = el('svg', { width: 20, height: 20, viewBox: "0 0 24 24", fill: "currentColor" },
    ...
    const emojiIcon = el('svg', { width: 20, height: 20, viewBox: "0 0 24 24", fill: "currentColor" },
