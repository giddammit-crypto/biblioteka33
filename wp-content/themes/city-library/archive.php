...
<div class="w-full max-w-[95%] lg:max-w-[90%] xl:max-w-[80%] mx-auto px-4 sm:px-6 lg:px-8 py-12">
    ...
    <div id="primary" class="w-full">
        ...
        <div class="content-area bg-white dark:bg-slate-900/50 p-8 rounded-3xl border border-slate-100 dark:border-slate-800 bg-pattern-slate" style="background-color: <?php echo esc_attr(get_theme_mod('content_bg_color', '#ffffff')); ?>;">
