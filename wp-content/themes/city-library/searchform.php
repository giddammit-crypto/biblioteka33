...
<form role="search" method="get" class="relative group" action="<?php echo esc_url(home_url('/')); ?>">
    <div class="relative flex items-center">
        <label for="<?php echo esc_attr($unique_id); ?>" class="sr-only"><?php echo esc_html_x('Поиск', 'label', 'city-library'); ?></label>
        ...
        <input type="search"
               ...
               class="w-full pl-12 pr-4 py-3 bg-slate-50 border-2 border-slate-200 focus:border-primary rounded-full text-slate-800 placeholder-slate-400 outline-none transition-all shadow-inner focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-primary focus-visible:ring-offset-2"
