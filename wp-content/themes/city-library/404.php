...
<div class="w-full max-w-[80%] mx-auto px-4 sm:px-6 lg:px-8 py-20">
    <div id="primary" class="w-full flex items-center justify-center min-h-[60vh]">

        <div class="text-center max-w-2xl mx-auto space-y-8 p-12 bg-white rounded-[2rem] shadow-xl border border-slate-100 relative overflow-hidden">
