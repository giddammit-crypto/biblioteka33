...
<a href="#main-content" class="sr-only focus:not-sr-only focus:absolute focus:top-0 focus:left-0 focus:z-[100] focus:bg-white focus:text-primary focus:p-4 focus:shadow-xl rounded-br-lg transition-all duration-300"><?php esc_html_e('Перейти к основному контенту', 'city-library'); ?></a>
