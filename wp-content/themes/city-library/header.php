...
<a class="absolute -top-full focus:top-0 left-0 z-[100] bg-primary text-white p-3 transition-all" href="#main-content">
    <?php _e('Перейти к содержимому', 'city-library'); ?>
</a>
