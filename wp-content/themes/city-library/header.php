...
<a class="absolute left-0 -top-full focus:top-0 focus:z-50 px-4 py-3 bg-white text-primary border border-slate-200 rounded-b-lg shadow-lg transition-all font-bold" href="#main-content">
