...
<a href="#main-content" class="sr-only focus:not-sr-only focus:absolute focus:top-0 focus:left-0 focus:z-[100] bg-white text-primary p-4 shadow-xl rounded-br-lg transition-all duration-300 font-bold border border-slate-200"><?php esc_html_e('Перейти к основному контенту', 'city-library'); ?></a>
