    ...
    <div class="w-full px-4 sm:px-6 lg:px-8">
        <div class="flex justify-between items-center h-20">
            <div class="flex items-center space-x-3 h-full py-2">
                <!-- Mobile Hamburger Button (Hidden in favor of bottom nav, but accessible if needed) -->
                <button id="mobile-menu-btn" class="hidden min-w-[44px] min-h-[44px] flex items-center justify-center -ml-2 text-slate-600 dark:text-slate-300 hover:text-primary transition-colors mobile-menu-trigger" aria-label="<?php esc_attr_e('Открыть меню', 'city-library'); ?>">
