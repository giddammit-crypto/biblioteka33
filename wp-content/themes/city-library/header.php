...
<a href="#main-content" class="absolute top-0 left-0 -translate-y-full focus:translate-y-0 z-[100] bg-primary text-white px-4 py-2 transition-transform duration-300"><?php _e('Skip to main content', 'city-library'); ?></a>
