    ...
    <div class="w-full px-4 sm:px-6 lg:px-8">
        <div class="flex justify-between items-center h-20">
            <div class="flex items-center space-x-3 h-full py-2">
                ...
                <button id="mobile-menu-btn" class="lg:landscape:hidden p-3 -ml-2 bg-white text-slate-600 hover:text-primary transition-all shadow-md rounded-full border border-slate-100" aria-label="<?php esc_attr_e('Открыть меню', 'city-library'); ?>" aria-controls="mobile-menu" aria-expanded="false">
