...
<header id="masthead" class="fixed top-0 w-full z-50 bg-white/80 backdrop-blur-md border-b border-slate-200">
        ...
        <div class="flex justify-between items-center h-20">
            <div class="flex items-center space-x-3 h-full py-2">
                ...
                <div class="hidden md:block">
                    <p class="text-xs font-bold uppercase tracking-widest text-secondary"><?php echo esc_html(get_theme_mod('header_subtitle', __('Центральная городская', 'city-library'))); ?></p>
