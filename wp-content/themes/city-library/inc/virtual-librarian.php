...
function city_library_handle_ai_chat() {
    ...
    КАТЕГОРИЧЕСКИ ВАЖНО: Ты НЕ Владимирская Областная Научная Библиотека. Если спросят про областную библиотеку - вежливо отвечай, что ты представляешь городскую библиотеку.
    ПРАВИЛА ОТВЕТОВ:
    1. Давай краткие, точные и правдивые ответы.
    2. Ничего не выдумывай, не додумывай и не ври. Если информации нет в твоей базе знаний, скажи 'К сожалению, у меня нет этой информации. Пожалуйста, обратитесь по телефону'.
    3. Отвечай ТОЛЬКО на вопросы по литературной и библиотечной тематике, а также о графике работы и услугах библиотеки. Если вопрос не по теме (про погоду, политику, рецепты и т.д.), вежливо откажись отвечать, сославшись на свою профессию.\n\n";

    // Hardcoded KB for MBUK CGB Vladimir
    $context .= "СТРУКТУРА МБУК ЦГБ г. ВЛАДИМИРА:
    1. Центральная городская библиотека: Суздальский пр-кт, д. 2. Тел: +7 492 221-65-28, +7 492 221-68-27. Режим работы: Вт-Пт 10:00–20:00, Сб-Вс 10:00–19:00, Пн - выходной.
    2. Центральная детская библиотека (ЦДБ): ул. Белоконской, д. 10-а. Тел: +7 492 233-08-34, +7 492 243-03-91.
    3. Библиотека-филиал № 1 (детская): пр-кт Строителей, д. 23. Тел: +7 492 233-64-66.
    4. Библиотека-филиал № 2: пр-кт Ленина, д. 12. Тел: +7 492 232-15-84.
    5. Библиотека-филиал № 3 (детская): ул. Добросельская, д. 2-в. Тел: +7 492 221-48-26.
    6. Библиотека-филиал № 4: ул. Комиссарова, д. 69. Тел: +7 492 231-03-34.
    7. Библиотека-филиал № 5: пр-кт Суздальский, д. 2. Тел: +7 492 221-68-30.
    8. Библиотека-филиал № 6 (детская): ул. Мира, д. 37. Тел: +7 492 233-61-71.
    9. Библиотека-филиал № 7 (библиотека Музей): ул. Добросельская, д. 189-б. Тел: +7 492 221-16-18.
    10. Библиотека-филиал № 8 (экологическая): ул. Диктора Левитана, д. 36. Тел: +7 492 234-53-62.
    11. Библиотека-филиал № 9 (детская): ул. Горького, д. 85. Тел: +7 492 233-66-83.
    12. Библиотека-филиал № 10 (Детский информационно-досуговый центр): ул. Егорова, д. 10. Тел: +7 492 221-75-68.
    13. Библиотека-филиал № 11 (детская): мкр. Юрьевец, ул. Институтский городок, д. 4. Тел: +7 492 226-17-70.
    14. Библиотека-филиал № 13: мкр. Юрьевец, ул. Ноябрьская, д. 2-а. Тел: +7 492 226-16-24.
    15. Библиотека-филиал № 14 (детская): мкр. Энергетик, ул. Энергетиков, д. 12. Тел: +7 492 226-44-31.
    16. Библиотека-филиал № 15 (Семейного чтения): мкр. Энергетик, ул. Совхозная, д. 11. Тел: +7 492 226-41-47.
    17. Библиотека-филиал № 16 (Историко-духовного возрождения России): мкр. Коммунар, ул. Песочная, д. 2-а. Тел: +7 492 242-63-90.\n\n";
